...
"Sign in to Harbor": "Iniciar sessão no Harbor",
  ...
  "Settings for this profile (shared or independent)": "Definições para este perfil (partilhadas ou independentes)",
  "PIN-locked profiles": "Perfis bloqueados com PIN",
  "Home style (Harbor curated / Classic Stremio)": "Estilo da página inicial (curadoria Harbor / Stremio clássico)",
  "When the latest episode ends (Hide / Timer)": "Quando o último episódio termina (Ocultar / Cronômetro)",
  ...
  "Local playback preference (Ask / Play local / Stream)": "Preferência de reprodução local (Perguntar / Reproduzir local / Transmitir)",
  "Export artwork sizes (Poster / Backdrop / Logo)": "Tamanhos de arte para exportação (Pôster / Fundo / Logotipo)",
  ...
  "Home rail categories (Movies, TV, Anime)": "Categorias das fileiras iniciais (Filmes, TV, Anime)",
  ...
  "Auto-apply audio-derived sync fixes": "Aplicar automaticamente correções de sincronização do áudio",
  "Community sync server URL": "URL do servidor de sincronização da comunidade",
  "Private mode (no community sync contact)": "Modo privado (sem contato com a sincronização da comunidade)",
  ...
  "Only streams already in your debrid library.": "Apenas fontes que já estão na sua biblioteca debrid.",
  "Min seeders": "Seeders mínimos",
  "Excludes direct and debrid streams with no seeders.": "Exclui fontes diretas e debrid sem seeders.",
  ...
  "A live preview of your player. Open the editor to move, hide, or reorder any control.": "Uma prévia ao vivo do seu player. Abra o editor para mover, ocultar ou reordenar qualquer controle.",
  ...
  "Adds a timer button next to Downloads. Set a time or episode limit from anywhere; playback pauses when it runs out.": "Adiciona um botão de temporizador ao lado de Downloads. Defina um limite de tempo ou de episódios de qualquer lugar; a reprodução pausa quando ele se esgota.",
  "After a moment on a slide, the featured title's trailer plays muted in the background. Uses more bandwidth.": "Após um momento em um slide, o trailer do título em destaque toca sem som ao fundo. Usa mais banda.",
  "After the current show's episodes, Next flows into your queue. Off keeps Next/Previous within the current show only.": "Após os episódios da série atual, Próximo segue para a sua fila. Desativado mantém Próximo/Anterior apenas dentro da série atual.",
  "After you pick a source, show a subtitle picker so you can set the exact track and language before the video starts. Off by default, Harbor keeps picking one for you automatically.": "Depois de escolher uma fonte, mostra um seletor de legendas para você definir a faixa e o idioma exatos antes de o vídeo começar. Desativado por padrão, o Harbor continua escolhendo uma para você automaticamente.",
  "Aired": "Exibido",
  ...
  "Any badges.json link works: a raw gist, Pastebin, or repo file. Broken JSON gets auto-repaired.": "Qualquer link badges.json funciona: um gist raw, Pastebin ou arquivo de repositório. JSON quebrado é reparado automaticamente.",
  ...
  "Audience": "Público",
  "Augments AI picks with current web results before asking the model. Powered by": "Complementa as escolhas da IA com resultados atuais da web antes de consultar o modelo. Com tecnologia de",
  ...
  "Bottom": "Inferior",
  "Build a named quality preference once and set it active. The picker prefers streams that match it, including the instant pick, and falls back to the next best source when nothing matches. Each filter ANDs its dimensions and ignores any you leave blank.": "Crie uma preferência de qualidade nomeada uma vez e defina-a como ativa. O seletor prioriza streams que a atendem, incluindo a escolha instantânea, e recorre à próxima melhor fonte quando nada corresponde. Cada filtro combina suas dimensões com E lógico e ignora as que você deixar em branco.",
  "Build a pack in any of these, export the JSON, host it as a gist, and paste the raw link below.": "Monte um pacote em qualquer um deles, exporte o JSON, hospede como um gist e cole o link raw abaixo.",
  ...
  "Corners keep it clear of subtitles along the bottom.": "Os cantos o mantêm afastado das legendas na parte inferior.",
  ...
  "Disabled because torrents are disabled above": "Desativado porque os torrents estão desativados acima",
  "Edit layout": "Editar layout",
  "Enable TV navigation above to use focus navigation in the player.": "Ative a navegação de TV acima para usar a navegação por foco no player.",
  "Enable all": "Ativar tudo",
  "Enable rule": "Ativar regra",
  "Episode 2": "Episódio 2",
  "Episode 3": "Episódio 3",
  "Episode 4": "Episódio 4",
  "Every format badge Harbor can show on streams. Click one to swap its art, hide it, or reset it. Changes apply everywhere badges appear.": "Todos os selos de formato que o Harbor pode exibir nos streams. Clique em um para trocar sua arte, ocultá-lo ou redefini-lo. As alterações se aplicam em todos os lugares onde os selos aparecem.",
  "Export artwork": "Exportar arte",
  "Export my setup": "Exportar minha configuração",
  "Extra large": "Extra grande",
  "Fetches DuckDuckGo results and feeds top hits into the model prompt.": "Busca resultados do DuckDuckGo e alimenta os principais no prompt do modelo.",
  "Fetching…": "Buscando…",
  "Files smaller than this are skipped when scanning a folder, so clips and samples stay out. Set to 0 to include everything.": "Arquivos menores que isso são ignorados ao escanear uma pasta, então clipes e amostras ficam de fora. Defina como 0 para incluir tudo.",
  "Finds anime saved under a movie or series id (which breaks Continue Watching and Trakt) and removes just those so they re-add correctly.": "Encontra animes salvos sob um id de filme ou série (o que quebra o Continuar Assistindo e o Trakt) e remove apenas esses para que sejam readicionados corretamente.",
  "Flags anime with an English dub. Also tags dub / sub / dual on stream sources.": "Marca animes com dublagem em inglês. Também rotula dub / sub / dual nas fontes de stream.",
  "Force player menus and panels to pure black, ignoring your theme tint.": "Força os menus e painéis do player para preto puro, ignorando o tom do seu tema.",
  "Found {n}: {names}. These are saved under the wrong id, which breaks Continue Watching and Trakt marking.": "Encontrados {n}: {names}. Estão salvos sob o id errado, o que quebra o Continuar Assistindo e a marcação do Trakt.",
  "Free tier": "Plano gratuito",
  "Give each score a home: on poster cards, on the detail page, or both. Flip the switch in each column.": "Dê um lugar a cada nota: nos cards de pôster, na página de detalhes ou em ambos. Alterne o botão em cada coluna.",
  "Glass": "Vidro",
  "Groq API key (gsk-...)": "Chave de API do Groq (gsk-...)",
  "Group Refresh on the left beside Back instead of the far right of the header.": "Agrupar Atualizar à esquerda, ao lado de Voltar, em vez de na extremidade direita do cabeçalho.",
  ...
  "Harbor will not start the torrent engine, contact trackers, or run DHT. Use this if you only want debrid and direct links. Turn off to re-enable torrent streaming.": "O Harbor não iniciará o mecanismo de torrent, não contatará trackers nem executará o DHT. Use isso se você quiser apenas debrid e links diretos. Desative para reativar o streaming por torrent.",
  ...
  "How big episode cards are in the strip and grid layouts. Bigger cards show larger artwork.": "O tamanho dos cards de episódio nos layouts em faixa e em grade. Cards maiores mostram artes maiores.",
  "How sharp trailers play. Auto follows your connection speed, and the Watch Trailer button targets 1080p. Pick 1080p or Best (up to 4K when the source has it) to force higher. 1080p and Best merge separate video and audio with the bundled ffmpeg, so they take a beat longer to start.": "A nitidez com que os trailers são reproduzidos. Automático segue a velocidade da sua conexão, e o botão Assistir Trailer prioriza 1080p. Escolha 1080p ou Melhor (até 4K quando a fonte tiver) para forçar uma qualidade maior. 1080p e Melhor combinam vídeo e áudio separados com o ffmpeg integrado, então demoram um pouco mais para começar.",
  "How the on-screen controls read while you watch.": "Como os controles na tela aparecem enquanto você assiste.",
  "How to make an award pack": "Como criar um pacote de prêmios",
  "Image URL (optional)": "URL da imagem (opcional)",
  "Image too large. Keep badge files under 250 KB.": "Imagem muito grande. Mantenha os arquivos de selo abaixo de 250 KB.",
  "Import": "Importar",
  ...
  "MB": "MB",
  "Make Harbor yours: swap the sidebar logo and the window/taskbar icon.": "Deixe o Harbor com a sua cara: troque o logo da barra lateral e o ícone da janela/barra de tarefas.",
  ...
  "Move focus with the keyboard, like a TV remote.": "Mova o foco com o teclado, como um controle remoto de TV.",
  "NEW": "NOVO",
  "Name (e.g. REMUX)": "Nome (ex.: REMUX)",
  "Native to Harbor. No RPDB or ratings addon needed.": "Nativo do Harbor. Sem necessidade de RPDB ou addon de avaliações.",
  "No badges match this title.": "Nenhum selo corresponde a este título.",
  "No custom rules yet. Add one below, or install a pack to bring some in.": "Nenhuma regra personalizada ainda. Adicione uma abaixo ou instale um pacote para trazer algumas.",
  "No issues found. Your anime library looks clean.": "Nenhum problema encontrado. Sua biblioteca de anime está limpa.",
  ...
  "Pick a source once and Harbor keeps playing the rest of that season from the same release, no re-picking. Works best with a debrid season pack. For anime it locks the whole series to that release.": "Escolha uma fonte uma vez e o Harbor continua reproduzindo o resto daquela temporada a partir do mesmo lançamento, sem escolher de novo. Funciona melhor com um pacote de temporada em debrid. Para anime, trava a série inteira nesse lançamento.",
  "Play a short sound when changing the player volume. Off by default.": "Reproduzir um som curto ao alterar o volume do player. Desativado por padrão.",
  ...
  "Poster": "Pôster",
  "Posters, logos, and title art load in the first available language from this list, falling back down the order. \\": "Pôsteres, logos e artes de título carregam no primeiro idioma disponível desta lista, recorrendo aos próximos na ordem. \\",
  "Provider": "Provedor",
  ...
  "Removes the Anime tab and every anime title from all rows everywhere: Home, Discover, Top 10, and catalogs. Western animation like Pixar is kept, and you can still find anime by searching.": "Remove a aba Anime e todos os títulos de anime de todas as fileiras em todo lugar: Início, Descobrir, Top 10 e catálogos. Animação ocidental como a Pixar é mantida, e você ainda pode encontrar anime buscando.",
  ...
  "SVP's files are here but its VapourSynth engine won't load ({err}). This usually means a stale VapourSynth entry or a missing Microsoft VC++ runtime. Reinstall SVP, or install the latest \\": "Os arquivos do SVP estão aqui, mas o motor VapourSynth não carrega ({err}). Isso geralmente significa uma entrada desatualizada do VapourSynth ou um runtime do Microsoft VC++ ausente. Reinstale o SVP ou instale o mais recente \\",
  ...
  "Serves this exact install of Harbor as a web app on your network. Open it on a phone, laptop, or TV browser, sign in there, and it streams through this computer. You can also use the phone remote to control playback and cast to another device on this machine.": "Disponibiliza esta instalação exata do Harbor como um app web na sua rede. Abra em um celular, notebook ou navegador de TV, faça login por lá, e ele transmite através deste computador. Você também pode usar o controle pelo celular para controlar a reprodução e transmitir para outro dispositivo nesta máquina.",
  "Set active": "Definir como ativo",
  "Settings for this profile": "Configurações deste perfil",
  "Setup copied to clipboard as JSON": "Configuração copiada para a área de transferência como JSON",
  ...
  "Show a laurel award tab on winning titles, like Netflix. Replaces the corner award chip and sits centered so it clears the rating and watchlist pills. Pick where it sits below.": "Mostrar uma aba de premiação com louros nos títulos vencedores, como a Netflix. Substitui o chip de prêmio no canto e fica centralizada para não sobrepor as pílulas de avaliação e de lista para assistir. Escolha abaixo onde ela fica.",
  ...
  "Show the player controls when you pause or resume using the keyboard. Turn off to keep them hidden so they don't cover subtitles.": "Mostrar os controles do player ao pausar ou retomar com o teclado. Desative para mantê-los ocultos e não cobrir as legendas.",
  ...
  "Square mark in the sidebar. Transparent PNG or SVG works best.": "Marca quadrada na barra lateral. PNG ou SVG transparente funciona melhor.",
  "Structured": "Estruturado",
  "Subtle audio feedback as you navigate and click. Off by default; pick a style to turn it on.": "Feedback sonoro sutil ao navegar e clicar. Desativado por padrão; escolha um estilo para ativar.",
  ...
  "The New, In Cinema, Rerun, and Awards chips. Turn off for a cleaner grid. Score chips are separate, below.": "Os chips Novo, No Cinema, Reprise e Prêmios. Desative para uma grade mais limpa. Os chips de nota são separados, abaixo.",
  "The TMDB community score.": "A nota da comunidade do TMDB.",
  "The badge that appears over the player when an episode syncs to your tracker.": "O selo que aparece sobre o player quando um episódio sincroniza com seu serviço de acompanhamento.",
  "The button set your layout is built on. Your customizations are kept separately for each style.": "O conjunto de botões que forma a base do seu layout. Suas personalizações são mantidas separadamente para cada estilo.",
  "The free tier is $0 for personal use. Just pick the first option, no payment needed.": "O plano gratuito é $0 para uso pessoal. Basta escolher a primeira opção, sem precisar pagar.",
  "The home hero trailer plays with sound and a mute button in the corner, then shows a replay button when it ends. Auto-rotation pauses so it stays on the featured title.": "O trailer do destaque da Início toca com som e um botão de mudo no canto, depois mostra um botão de repetir quando termina. A rotação automática pausa para permanecer no título em destaque.",
  "The little 4K, HDR, codec, and audio chips that ride along each stream in the play picker.": "Os pequenos chips 4K, HDR, codec e áudio que acompanham cada stream no seletor de reprodução.",
  "The little score chip printed on poster cards across your rows and grids.": "O pequeno chip de nota impresso nos cards de pôster nas suas fileiras e grades.",
  "The ratings row on a title's detail page, next to runtime and genre.": "A linha de avaliações na página de detalhes de um título, ao lado da duração e do gênero.",
  "The resolution Harbor downloads for each image when you export a title's metadata next to the file on disk.": "A resolução que o Harbor baixa para cada imagem ao exportar os metadados de um título junto ao arquivo no disco.",
  "The window and taskbar icon updates right away. The installed shortcut refreshes on the next update.": "O ícone da janela e da barra de tarefas muda na hora. O atalho instalado é atualizado na próxima atualização.",
  "These badges are drawn on posters as you browse. RPDB, in the keys above, is a separate option that bakes scores into the poster image itself.": "Estes selos são desenhados nos pôsteres enquanto você navega. O RPDB, nas chaves acima, é uma opção separada que grava as notas na própria imagem do pôster.",
  "This score only appears on cards.": "Esta nota só aparece nos cards.",
  "Top 10 ribbon": "Faixa Top 10",
  "Torrents are disabled. Uncached streams will not play unless they come from a debrid service or a direct link. To use torrents, toggle this off.": "Os torrents estão desativados. Streams não armazenados em cache não serão reproduzidos, a menos que venham de um serviço debrid ou de um link direto. Para usar torrents, desative isso.",
  "True black menus": "Menus em preto absoluto",
  "Try it": "Experimentar",
  "Turn off to hide the sync badge during playback.": "Desative para ocultar o selo de sincronização durante a reprodução.",
  "Type what you want in plain language and let a model find it. Bring your own API key.": "Digite o que você quer em linguagem natural e deixe um modelo encontrá-lo. Use sua própria chave de API.",
  "Updating separated settings per profile, which may have reset your theme and keys. Harbor still has your old setup saved. Bring it back on this profile, then reload.": "Atualizando as configurações separadas por perfil, o que pode ter redefinido seu tema e suas chaves. O Harbor ainda tem sua configuração antiga salva. Restaure-a neste perfil e recarregue.",
  "Upload": "Enviar",
  "Upload image": "Enviar imagem",
  "Upload multiple images": "Enviar várias imagens",
  "Use arrows and Select/Space to move focus between player controls. Turn this off to keep arrows for seeking and Space for play/pause.": "Use as setas e Selecionar/Espaço para mover o foco entre os controles do player. Desative isso para manter as setas para navegar no vídeo e o Espaço para reproduzir/pausar.",
  "Use in Nuvio": "Usar no Nuvio",
  "Use live web context": "Usar contexto da web em tempo real",
  "Use the arrow keys and Enter to move focus through Harbor. Turn this off to keep arrow keys free and disable focus navigation everywhere.": "Use as teclas de seta e Enter para mover o foco pelo Harbor. Desative isso para deixar as teclas de seta livres e desativar a navegação por foco em todos os lugares.",
  "Use your own image as the app icon": "Usar sua própria imagem como ícone do app",
  "Watchlist bookmark": "Marcador de watchlist",
  "When Esc would close the player, show a quick confirm first. You can tick \\": "Quando o Esc fecharia o player, mostrar uma confirmação rápida primeiro. Você pode marcar \\",
  "When off, a torrent stops the moment you close or switch the stream, so nothing keeps downloading in the background. Turn on to let it keep going after you leave; manage or pause those from the Downloads tab.": "Quando desativado, um torrent para no momento em que você fecha ou troca o stream, então nada continua baixando em segundo plano. Ative para deixá-lo continuar depois que você sair; gerencie ou pause esses downloads na aba Downloads.",
  "Where scores appear": "Onde as notas aparecem",
  "Where the Refresh button sits in the picker header. Default keeps it on the right, across from Back.": "Onde o botão Atualizar fica no cabeçalho do seletor. O padrão o mantém à direita, do lado oposto ao Voltar.",
  "Which order": "Qual ordem",
  "While you watch": "Enquanto você assiste",
  "Wide logo shown beside the mark when the sidebar is expanded.": "Logotipo largo exibido ao lado da marca quando a barra lateral está expandida.",
  "Wordmark": "Logotipo",
  "Your own badges, matched against the stream's name with a pattern. Great for release groups, providers, or anything the built-in badges don't cover. Imported packs land here too.": "Seus próprios selos, comparados ao nome do stream com um padrão. Ótimo para grupos de lançamento, provedores ou qualquer coisa que os selos integrados não cubram. Pacotes importados também aparecem aqui.",
  "by {name}": "por {name}",
  "copied!": "copiado!",
  "for higher rate limits; leave blank for the free anonymous tier.": "para limites de taxa mais altos; deixe em branco para o plano anônimo gratuito.",
  "jina_...": "jina_...",
  "skipped": "ignorado",
  ...
  "tvOS": "tvOS",
  "Living-room focus, floating glass chrome.": "Foco de sala de estar, interface de vidro flutuante.",
  ...
  "If a stream hasn't started playing within 10 seconds (a dead source or an addon that's down), automatically try the next available stream. Off by default.": "Se um stream não começar a reproduzir em 10 segundos (uma fonte morta ou um addon fora do ar), tenta automaticamente o próximo stream disponível. Desativado por padrão.",
