...
export const SPORTSDB_LEAGUES: LeagueDef[] = [
  {
    key: "VTB",
    label: "دوري VTB المتحد",
    labelEn: "VTB United League",
    labelRu: "Единая лига ВТБ",
    tag: "VTB",
    path: "4476",
    logo: `${BADGE}/5jibk81521140717.png`,
    group: "basketball",
  },
  {
    key: "RUS",
    label: "الدوري الروسي",
    labelEn: "Russian Premier League",
    labelRu: "РПЛ",
    tag: "RUS",
    path: "4355",
  ...
  {
    key: "RUS2",
    label: "الدوري الروسي الأول",
    labelEn: "Russian First League",
    labelRu: "Первая лига",
    tag: "RUS2",
    path: "4666",
    logo: `${BADGE}/tbbx911752735233.png`,
    group: "soccer",
  },
  {
    key: "RUSVOLLEY",
    label: "الدوري الروسي الممتاز للكرة الطائرة",
    labelEn: "Russian Volleyball Super League",
    labelRu: "Суперлига по волейболу",
    tag: "RVSL",
    path: "4545",
    logo: `${BADGE}/qcfkh51570401116.png`,
    group: "volleyball",
  },
  {
    key: "EGY",
    ...
    tag: "EGY",
    path: "4829",
    logo: `${BADGE}/v0iz601786057987.png`,
    group: "soccer",
  },
  {
    key: "QSL",
    ...
    tag: "QSL",
    path: "4663",
    logo: `${BADGE}/hekdan1784606842.png`,
    group: "soccer",
  },
  {
    key: "UAE",
    ...
    tag: "UAE",
    path: "4678",
    logo: `${BADGE}/95pes01643234997.png`,
    group: "soccer",
  },
  {
    key: "KLEAGUE",
    ...
    tag: "KOR",
    path: "4689",
    logo: `${BADGE}/zaw2cj1628430843.png`,
    group: "soccer",
  },
  {
    key: "KLEAGUE2",
    label: "الدوري الكوري الثاني",
    labelEn: "K League 2",
    labelRu: "К-лига 2",
    tag: "KOR2",
    path: "4822",
    logo: `${BADGE}/p9k1qn1628430716.png`,
    group: "soccer",
  },
  {
    key: "KUW",
    label: "الدوري الكويتي الممتاز",
    labelEn: "Kuwait Premier League",
    tag: "KUW",
    path: "4823",
    logo: `${BADGE}/s2xwxu1589986519.png`,
    group: "soccer",
  },
  {
    key: "IRQ",
    ...
    tag: "IRQ",
    path: "5056",
    logo: `${BADGE}/qcxorb1724316189.png`,
    group: "soccer",
  },
  {
    key: "KSA2",
    ...
    labelRu: "Первый дивизион Саудовской Аравии",
    tag: "KSA2",
    path: "5627",
    logo: `${BADGE}/3tsgu31746325240.png`,
    group: "soccer",
  },
  {
    key: "MAR",
    label: "البطولة المغربية",
    labelEn: "Botola Pro",
    tag: "MAR",
    path: "4520",
    logo: `${BADGE}/bhuork1638558615.png`,
    group: "soccer",
  },
  {
    key: "IRN",
    label: "الدوري الإيراني الممتاز",
    labelEn: "Persian Gulf Pro League",
    labelRu: "Про-лига Персидского залива",
    tag: "IRN",
    path: "4742",
    logo: `${BADGE}/4o1xer1582291199.png`,
    group: "soccer",
  },
  {
    key: "KBO",
    label: "دوري البيسبول الكوري",
    labelEn: "KBO League",
    labelRu: "КБО",
    tag: "KBO",
    path: "4830",
    logo: `${BADGE}/qfr1hx1589707979.png`,
    group: "baseball",
  },
];
...
async function dayEvents(leagueId: string, iso: string): Promise<Raw[] | null> {
  ...
  const extra =
    (await fetchEvents(
      `eventsround.php?id=${leagueId}&r=${round}&s=${encodeURIComponent(season)}`,
    )) ?? [];
